            ...
            return (
              ...
              >
                ...
                {isEven ? (
                  <>
                    {/* LEFT CARD */}
                    <div className="pl-12 md:pl-0 md:w-1/2 md:pr-12 text-left md:text-right">
                      <div className="glass-panel p-6 rounded-2xl border-l-4 md:border-l-0 md:border-r-4 border-cyber-secondary hover:border-cyber-secondary/50 transition-all duration-300 shadow-md">
                  ...
                  <>
                    ...
                    {/* RIGHT CARD */}
                    <div className="pl-12 md:pl-12 md:w-1/2 text-left">
                      <div className="glass-panel p-6 rounded-2xl border-l-4 border-cyber-secondary hover:border-cyber-secondary/50 transition-all duration-300 shadow-md">
